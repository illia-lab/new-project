 ...
 * @property {{index?: number; action: MessageItemCommonAction;} & MessageItemGetResAction} [MyMessage] MyMessage
 ...
 *  @property {MessageItemCommonAction[]} [MyMessage] MyMessage
...
class MessageFormFragment extends BaseFragment {
  constructor(root, name) {
    ...
    this.adminMessage = this.init('.message_body.text-left', 'Admin message', Collection, MessageItemFragment);
